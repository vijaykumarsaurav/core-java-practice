...
public class DaysCount {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Remain days: " +td);
		System.out.println("Remain months: " +(float)(td)/30);
		System.out.println("Remain years : " +(float)(td)/365);
		System.out.println("Remain Hours: " +(td*24));
		System.out.println("Remain Minutes: " +(td*24*60));
		System.out.println("Remain Millisecands: " +dml);
